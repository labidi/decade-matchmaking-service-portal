...
export default function UserGuide() {
    ...
    return (
        <>
            {UserGuideFile && (
                <section className="bg-casal-900 py-20 px-4 text-center text-white">
                            ...
                            <div className=" p-4 flex flex-col leading-normal">
                                <div className="mb-8">
                                    <p className="text-white text-2xl">
                                        ...
                                        Log in to submit a request for training or workshops, or explore currently available opportunities offered by CDF Partners. <br />
                                    </p>
                                    <p className="text-white text-2xl py-4">
                                        Are you part of an organization that provides capacity development services? <br />
                                        Looking to expand your reach or promote your activities? This platform is the right place for you.  <br />
                                        As a partner, you can both view training needs and submit your own opportunities. <br />
