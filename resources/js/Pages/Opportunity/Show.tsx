                    ...
                    <dl className="grid grid-cols-1 sm:grid-cols-2">
                        <div className="border-t border-gray-100 dark:border-gray-700 px-4 py-6 sm:col-span-1 sm:px-0">
                            ...
                            <dd className="mt-1 text-sm/6 text-gray-700 dark:text-gray-300 sm:mt-2">
                                {opportunity.co_organizers?.map((item) => (
                        ...
                        <div className="border-t border-gray-100 dark:border-gray-700 px-4 py-6 sm:col-span-1 sm:px-0">
                            ...
                            <dd className="mt-1 text-sm/6 text-gray-700 dark:text-gray-300 sm:mt-2">{opportunity.implementation_location?.map((item) => (
                        ...
                        <div className="border-t border-gray-100 dark:border-gray-700 px-4 py-6 sm:col-span-1 sm:px-0">
                            ...
                            <dd className="mt-1 text-sm/6 text-gray-700 dark:text-gray-300 sm:mt-2">{opportunity.target_audience?.map((item) => (
                                <Badge key={item.value} color="blue" className="mr-1 mb-1">
                                    {item.label}
                                </Badge>
                            ))}
                        ...
                        <div className="border-t border-gray-100 dark:border-gray-700 px-4 py-6 sm:col-span-1 sm:px-0">
                            ...
                            <dd className="mt-1 text-sm/6 text-gray-700 dark:text-gray-300 sm:mt-2">{opportunity.thematic_areas?.map((item) => (
                                <Badge key={item.value} color="blue" className="mr-1 mb-1">
                                    {item.label}
                                </Badge>
                            ))}
                        ...
                        <div className="border-t border-gray-100 dark:border-gray-700 px-4 py-6 sm:col-span-1 sm:px-0">
                            ...
                            <dd className="mt-1 text-sm/6 text-gray-700 dark:text-gray-300 sm:mt-2">{opportunity.target_languages?.map((item) => (
                                <Badge key={item.value} color="blue" className="mr-1 mb-1">
                                    {item.label}
                                </Badge>
                            ))}
                        ...
                        <div className="border-t border-gray-100 dark:border-gray-700 px-4 py-6 sm:col-span-1 sm:px-0">
                            ...
                            <dd className="mt-1 text-sm/6 text-gray-700 dark:text-gray-300 sm:mt-2">
                                {opportunity.key_words?.map((item) => (
                                    <Badge key={item} color="blue" className="mr-1 mb-1">
                                        {item}
                                    </Badge>
                                ))}
