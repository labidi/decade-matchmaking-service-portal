                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            >
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-sm text-gray-500">Submit a new capacity development request</p>
                                </div>
                            </a>
                            ...
                            >
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-sm text-gray-500">Create a new training opportunity</p>
                                </div>
                            </a>
                            ...
                            >
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-sm text-gray-500">Browse all capacity development requests</p>
                                </div>
                            </a>
                            ...
                            >
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-sm text-gray-500">Discover available training opportunities</p>
                                </div>
                            </a>
                        </div>
                    </div>
