            ...
            <div className="space-y-8">
                ...
                <div>
                    <div className="px-4 sm:px-0">
                        ...
                        <p className="mt-1 max-w-2xl text-sm/6 text-gray-500">Basic information about the request and applicant.</p>
                    </div>
                ...
                <div>
                    <div className="px-4 sm:px-0">
                        ...
                        <p className="mt-1 max-w-2xl text-sm/6 text-gray-500">Detailed information about the capacity development activity.</p>
                    </div>
                    <div className="mt-6 border-t border-gray-100">
                        <dl className="divide-y divide-gray-100">
                            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            {request.detail.is_related_decade_action !== 'Yes' && (
                                <>
                                    <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                        <dt className="text-sm/6 font-medium text-gray-900">Linked to Broader Initiative</dt>
                                    ...
                                    {request.detail.project_url && (
                                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            ...
                                            <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">
                                                <a href={request.detail.project_url} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-500">
                                                    {request.detail.project_url}
                                                </a>
                                            </dd>
                                        </div>
                            ...
                            {request.detail.is_related_decade_action === 'Yes' && (
                                <>
                                    <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                        <dt className="text-sm/6 font-medium text-gray-900">Significant Changes Since Endorsement</dt>
                ...
                <div>
                    <div className="px-4 sm:px-0">
                        ...
                        <p className="mt-1 max-w-2xl text-sm/6 text-gray-500">Information about capacity needs and target audience.</p>
                    </div>
                    <div className="mt-6 border-t border-gray-100">
                        <dl className="divide-y divide-gray-100">
                            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    {request.detail.support_types && request.detail.support_types.length > 0 ? (
                                        <div className="flex flex-wrap gap-2">
                                            {request.detail.support_types.map((type, index) => (
                                                <span key={index} className="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-700/10">
                                                    {type}
                                                </span>
                                            ))}
                                        </div>
                            ...
                            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                <dt className="text-sm/6 font-medium text-gray-900">Capacity Development Gap Description</dt>
                ...
                <div>
                    <div className="px-4 sm:px-0">
                        ...
                        <p className="mt-1 max-w-2xl text-sm/6 text-gray-500">Partner and financial support information.</p>
                    </div>
                    <div className="mt-6 border-t border-gray-100">
                        <dl className="divide-y divide-gray-100">
                            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <div>
                    <div className="px-4 sm:px-0">
                        ...
                        <p className="mt-1 max-w-2xl text-sm/6 text-gray-500">Risk assessment and impact information.</p>
                    </div>
                    <div className="mt-6 border-t border-gray-100">
                        <dl className="divide-y divide-gray-100">
                            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
